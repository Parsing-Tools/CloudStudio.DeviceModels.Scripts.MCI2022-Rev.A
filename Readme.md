...
# Parsing + Configuration Script – MCI2022 - Rev. A

This **Parsing + Configuration** script is designed for the **MCI2022** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – MCI2022 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **MCI2022** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
